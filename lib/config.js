...
/** Submissions: one folder per model, each with output.html + WRITEUP.md. */
export const SUBMISSIONS_DIR = resolve(ROOT, "output");
/** Where encode/decode write the winner's QR + decoded page. */
 ...
 * @returns {string}
 */
export function toDataUrl(html) {
