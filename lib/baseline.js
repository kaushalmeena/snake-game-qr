 ...
 * html-minifier with every size option it offers turned on. The
 * leaderboard shows it as the floor a model must beat to be worth anything —
 * it lives here, outside output/, so it never counts as a submission.
 */

export const label = "html-minifier";
